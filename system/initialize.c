...
struct sys_call_pid summ_table[NPROC];  /*Table to print system call summary*/
...
/*           for(l=0;l<8;l++)*/
/*           {*/
/*              summ_table[k].syssumm[l].count=0;*/
/*              summ_table[k].syssumm[l].total_cycles=0;*/
/*           }*/
/*       }*/
	...
	prptr->prstkptr = 0;
        /* Initialize creation_time for null process*/
