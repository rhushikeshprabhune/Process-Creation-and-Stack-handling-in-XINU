	...
	)
{
	...
	*pushsp = (unsigned long) (prptr->prstkptr = (char *)saddr);
        ...
        summ_table[currpid].syssumm[0].total_cycles = summ_table[currpid].syssumm[0].total_cycles + (end - start);
        summ_table[currpid].syssumm[0].count = summ_table[currpid].syssumm[0].count + 1;
	restore(mask);
	return pid;
}
